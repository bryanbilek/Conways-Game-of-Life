...
function About() {
  return (
    <div className="about">
      ...
      <p>
        1) Births: Each dead cell adjacent to exactly three live neighbors will
        become live in the next generation
      </p>

      <p>
        2) Death by isolation: Each live cell with one or fewer live neighbors
        will die in the next generation
      </p>

      <p>
        3) Death by overcrowding: Each live cell with four or more live
        neighbors will die in the next generation
      </p>

      <p>
        4) Survival: Each live cell with either two or three live neighbors will
